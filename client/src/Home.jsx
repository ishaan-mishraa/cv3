    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="intro-container py-10">
        <div className="top-image flex justify-center">
          <img src="./assets/images/studying.png" alt="Studying" className="study-image rounded-full w-48 h-48 sm:w-60 sm:h-60 md:w-72 md:h-72" />
        </div>
        <div className="intro-head flex justify-center text-lg mt-6">
          <p className="p1 text-center">
            I am <span className="intro-name text-4xl sm:text-5xl md:text-6xl">Ishaan Mishra</span>.<br />
      ...
      <div id="skills">
        ...
        <div className="skill-upper-layer flex justify-evenly mt-6">
          <div className="skill-info text-center">
            <img className="image-skill w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16" src="./assets/images/c-.png" alt="C++" />
            <h2 className="secondary-titles text-lg sm:text-xl md:text-2xl mt-2">C++</h2>
          </div>
          <div className="skill-info text-center">
            <img className="image-skill w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16" src="./assets/images/html-5.png" alt="HTML" />
            <h2 className="secondary-titles text-lg sm:text-xl md:text-2xl mt-2">HTML</h2>
          </div>
          <div className="skill-info text-center">
            <img className="image-skill w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16" src="./assets/images/css-3.png" alt="CSS" />
            <h2 className="secondary-titles text-lg sm:text-xl md:text-2xl mt-2">CSS</h2>
          </div>
          <div className="skill-info text-center">
            <img className="image-skill w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16" src="./assets/images/js.png" alt="Javascript" />
        ...
        <div className="skill-lower-layer flex justify-evenly mt-6">
          <div className="skill-info text-center">
            <img className="image-skill w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16" src="./assets/images/pngegg.png" alt="PostgreSQL" />
            <h2 className="secondary-titles text-lg sm:text-xl md:text-2xl mt-2">PostgreSQL</h2>
          </div>
          <div className="skill-info text-center">
            <img className="image-skill w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16" src="./assets/images/nodejs.png" alt="NodeJS" />
            <h2 className="secondary-titles text-lg sm:text-xl md:text-2xl mt-2">NodeJS</h2>
          </div>
          <div className="skill-info text-center">
            <img className="image-skill w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16" src="./assets/images/atom.png" alt="ReactJS" />
            <h2 className="secondary-titles text-lg sm:text-xl md:text-2xl mt-2">ReactJS</h2>
          </div>
          <div className="skill-info text-center">
            <img className="image-skill w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16" src="./assets/images/linux.png" alt="Linux" />
